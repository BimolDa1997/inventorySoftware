						...
						<div class="card">
					        <div class="card-body">
						        <table class="text-center" style="width:100%">
										...
										?>
										<tr>
			<td><input name="item_name_<?=$item_data['id'];?>"  id="item_name_<?=$item_data['id'];?>" type="hidden" value="<?=$item_data['item_id'];?>">
				<input type="hidden" name="update_id_<?=$item_data['id'];?>" id="update_id_<?=$item_data['id'];?>"  value="<?=$item_data['id'];?>" />
				<?=find_a_field2('item_info','concat(item_code,"-",item_name)','item_id='.$item_id);?>	
			</td>							
			<td>
				<input name="color_<?=$item_data['id'];?>"  id="color_<?=$item_data['id'];?>" type="hidden" value="<?=$item_data['color'];?>" />
				<?=find_a_field2('color_list','color','id='.$item_data['color']);?>
			</td>		
