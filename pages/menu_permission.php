														...
														<div class="row">
															...
															<div class="col-md-12">
																...
																<div class="form-group form-group-default">
                                                                    ...
                                                                    <? foreign_relation('users','user_id','username',$_POST['user'],'1 and del=0');?>
                                                            ...
                                                            <div class="col-md-12">
																...
																<div class="form-group form-group-default">
                                                                    ...
                                                                    <? foreign_relation('menu','id','menu_name',$_POST['menu'],'');?>
									...
									<div class="table-responsive">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<?php
											  ...
											  $select =$conn->query("select p.*,m.menu_name,f.feature_name,u.username from menu_permission p, menu m, feature f, users u where u.user_id=p.user_id and f.id=m.feature and m.id=p.menu_id");
