...
if(isset($_POST['loan_return'])){
   ...
   $amount = $_POST['amount'];
   $entry_by = $_SESSION['user_id'];
 	$r_dealer = find_a_field('donar_info','donar_id','donar_name like "'.$donar_name.'"');
	
   if($r_dealer=='' || $r_dealer==0){
   $insert =$conn->query("insert into donar_info(`donar_name`,`group_for`) values('".$donar_name."','".$_SESSION['group_for']."')");
   $r_dealer = mysqli_insert_id($conn);
   }


if($_POST['type1'] =='Loan Take'){
$tr_from = 'Loan Return';

$rcv_dr = "INSERT INTO `loan_history` (`jv_no`, `jv_date`, `donar_id`,`paid_amt` , `tr_from`,`entry_by`,`group_for`,`narration`,`money_receipt`) VALUES ('".$max_jv."','".$jv_date."', '".$r_dealer."', '".$amount."','".$tr_from."','".$entry_by."','".$_SESSION['group_for']."','".$details."','".$details."')";
...
$tr_from = 'Loan Receive';

$rcv_dr = "INSERT INTO `loan_history` (`jv_no`, `jv_date`, `donar_id`,`loan_amt` , `tr_from`,`entry_by`,`group_for`,`narration`,`money_receipt`) VALUES ('".$max_jv."','".$jv_date."', '".$r_dealer."', '".$amount."','".$tr_from."','".$entry_by."','".$_SESSION['group_for']."','".$details."','".$details."')";
						...
						<div class="row">
                            ...
                            <div class="col-md-6 align-items-right">
										...
										<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#withoutSales">
											...
											(<i class="fa fa-plus"></i>) Give Loan
										...
										<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#LoanReturn">
											...
											(<i class="fa fa-minus"></i>) Loan Receive
									...
									<div class="table-responsive">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<?php
											 ...
											 $sql = "select l.id, l.jv_date,l.narration,l.tr_from, l.loan_amt as total, l.paid_amt, d.donar_name,d.donar_id from loan_history l, donar_info d where l.donar_id=d.donar_id order by l.id desc  ";
											 ...
											 while($c_data = $select->fetch_assoc()){ 
                                                ...
                                                if($c_data['tr_from']=="Loan" || $c_data['tr_from']=="Loan Receive"){
													...
													<p class="small">* Mendatory Field</p>
														...
														<div col-sm-4>
															...
															<select name="type1" id="type1" class="form-control" >
																<option value="Loan Take">Loan Receive</option>
