...
$max_jv = $max_jv+1; 
 ...
 $rcv_dr1 = "INSERT INTO `journal` (`jv_no`, `jv_date`, `ledger_id`,`dr_amt`,`cr_amt`, `tr_from`, `tr_no`, `group_for`,`status`,`entry_by`) VALUES ('".$max_jv."','".$jv_date."','".$cr_ledger."','".$due."',0,'".$tr_from."','".$insert_id."', '".$group_for."','".$status."','".$entry_by."')";
...
$journal_insert_dr1 =$conn->query($rcv_dr1);
 ...
 $rcv_cr1 = "INSERT INTO `journal` (`jv_no`, `jv_date`, `ledger_id`,`dr_amt`,`cr_amt`, `tr_from`, `tr_no`, `group_for`,`status`,`entry_by`) VALUES ('".$max_jv."','".$jv_date."','".$ledger_id."',0,'".$due."','".$tr_from."','".$insert_id."', '".$group_for."','".$status."','".$entry_by."')";
...
$max_jv = $max_jv+1;
 ...
 $rcv_dr = "INSERT INTO `journal` (`jv_no`, `jv_date`, `ledger_id`,`dr_amt`,`cr_amt`, `tr_from`, `tr_no`, `group_for`,`status`,`entry_by`) VALUES ('".$max_jv."','".$jv_date."','".$cr_ledger."','".$advance."',0,'".$tr_from."','".$insert_id."', '".$group_for."','".$status."','".$entry_by."')";
...
$journal_insert_dr =$conn->query($rcv_dr);
 ...
 $rcv_cr = "INSERT INTO `journal` (`jv_no`, `jv_date`, `ledger_id`,`dr_amt`,`cr_amt`, `tr_from`, `tr_no`, `group_for`,`status`,`entry_by`) VALUES ('".$max_jv."','".$jv_date."','".$ledger_id."',0,'".$advance."','".$tr_from."','".$insert_id."', '".$group_for."','".$status."','".$entry_by."')";
...
$insert_id = $update_id;
  ...
  $found_opening = find_a_field('journal','jv_no','ledger_id="'.$ledger.'" and tr_from="Advance"');
  
  $found_due = find_a_field('journal','jv_no','ledger_id="'.$ledger.'" and tr_from="Due"');
   ...
   if($ledger>0){
    $del = $conn->query("delete from journal where jv_no='".$found_opening."' and tr_from='Advance'");
	
	 $del = $conn->query("delete from journal where jv_no='".$found_due."' and tr_from='Due'");
