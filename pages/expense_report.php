                     ...
                     <div class="row">
								...
								<div class="card-header">
									...
									<div class="row">
									   ...
									   <form action="" method="post">
									     <div class="row">
									      <div class="col-4">
										     <input type="date" class="form-control" name="fdate" value="<?=$_POST['fdate'];?>"  />
										  </div>
										  <div class="col-4">
										     <input type="date" class="form-control" name="tdate" value="<?=$_POST['tdate'];?>"  />
										  </div>
										   <div class="col-2">
						...
						<?php if(isset($_POST['show'])) { ?>			
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
											<?php
											  $select =$conn->query("select j.*,a.ledger_name from journal j, ledger a where 1 and j.tr_from='Expense' and j.group_for=".$_SESSION['group_for']." and j.dr_amt>0 and a.ledger_id=j.ledger_id and j.jv_date between '".$_POST['fdate']."' and '".$_POST['tdate']."' order by j.jv_date desc ");
											 while($c_data = $select->fetch_assoc()){ ?>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer no-bd">
													...
													<input type="submit" name="save" id="addRowButton" value="Update" class="btn btn-primary" />
