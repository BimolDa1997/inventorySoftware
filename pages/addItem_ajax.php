...
//$sql = 'insert into pos_sale_detail set sequence="'.$sequence.'",sale_no="'.$sale_no.'",item_id="'.$item_id.'",rate="'.$item_price.'",qty="0",pure_amt="'.$item_price.'",grand_total="'.$item_price.'",sale_date="'.date('Y-m-d').'",entry_by="'.$_SESSION['user_id'].'",entry_at="'.date('Y-m-d H:i:s').'",warehouse="'.$warehouse_id.'",group_for="'.$group_for.'"';
...
<tr>
  ...
  <th style="padding: 0.2rem;" scope="col" width="100">Stock</th>
