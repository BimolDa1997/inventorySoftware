...
if(isset($_POST['loan_return'])){
  ...
  $insert = $conn->query("insert into donar_info(`donar_name`,`group_for`,`ledger_id`,`donar_type`) values('".$donar_name."','".$_SESSION['group_for']."' ,'".$ledger_id."' , 'Take Loan')");
						...
						<div class="row">
                            ...
                            <div class="col-md-6 align-items-right">
										...
										<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#withoutSales">
											...
											(<i class="fa fa-plus"></i>) Loan take
										...
										(<i class="fa fa-minus"></i>) Loan Return</button>
									...
									<div class="table-responsive">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<?php
											  ...
											  $sql = "select l.id, l.jv_date , l.narration , l.tr_from, sum(cr_amt-dr_amt) as total, d.ledger_name as donar_name,d.ledger_id from journal l, ledger d where l.ledger_id !=1000007 and l.ledger_id=d.ledger_id and tr_from like 'Loan' GROUP BY l.ledger_id order by l.id desc ";
