...
if(isset($_POST['save'])){
  ...
  echo $sql = "insert into sub_sub_category_info(`category`,`priority`,`entry_by`, `group_for`, `category_id`, `sub_category_id`) 
  
  Values('".$category."', '".$priority."','". $entry_by."', '".$group_for."', '".$category_id."', '".$sub_category_id."') ";
...
if(isset($_POST['update'])){
  ...
  if($update_id>0){
  $update = $conn->query("update sub_sub_category_info set category='".$category."',priority='".$priority."',category_id = '".$category_id."' 
  
  ,sub_category_id = '".$sub_category_id."' where id='".$update_id."'");
  ...
  $msg =  '<span style="color:red; font-weight:bold; font-size:18px;">Plesae Try Again!</span>';
	...
	if(isset($_GET['del'])){
		...
		$delete = $conn->query("delete from sub_sub_category_info where id='".$del_id."'");
		...
		echo '<script>window.location.href = "sub_sub_categories.php";</script>';
	}
 ?>
								...
								<div class="card-body">
														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Sub Sub Category <span style="color:#FF0000; font-size:15px;">*</span></label>
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<select name="category_id" id="category_id" onchange="get_sub_category(this.value)" required>
																		<option value=""></option>
																		<?php
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	...
																	<select name="sub_category_id" id="sub_category_id" required>
																		<?php
																			foreign_relation('sub_category_info','id','category','','1 order by category asc');
																		?>
																	</select>
																</div>
															</div>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
											<?php
											  $select =$conn->query("select s.*,c.category as category_name,d.category as sub_category_name 
											  from sub_sub_category_info s, category_info c, sub_category_info d 
											  where s.category_id=c.id and s.sub_category_id=d.id order by s.priority asc");
											  $sl=1;
													...
													<p class="small">Make Sure Fillup All Field</p>
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Category <span style="color:#FF0000; font-size:15px;">*</span></label>
																	<select name="category_id" id="category_id2" required>
																		<?php
															...
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Sub Category <span style="color:#FF0000; font-size:15px;">*</span></label>
																	<select name="sub_category_id" id="sub_category_id2" required>
																		<?php
																			foreign_relation('sub_category_info','id','category',$c_data['sub_category_id'],' 1 order by category asc');
																		?>
																	</select>
																</div>
															</div>
